...
replies = prometheus_client.Counter('bot_replies', "Count of objects replied to", ['source', 'type', 'trigger'])
mentions = prometheus_client.Counter('bot_mentions', "Count of username mentions detected in inbox", ['type'])
